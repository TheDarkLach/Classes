...
//lots of cin.clear and ignores to clear buffer
...
int main() {
  bool run = true;
  char input[10];
  char ttl[30]; //for title input
  int yr; //for year input
  //media vector
  ...
  while(run) {
    ...
    //if input is invalid
      ...
      cout << "Invalid input. Type in ADD, SEARCH, DELETE, or QUIT." << endl;
    }
  }
  return 0;
}
